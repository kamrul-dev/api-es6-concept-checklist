/* 
    1. Object with propeties (string , boolean, number, object, array, method which will return a property value).
    2.Template string. minimum 3 property will be dynamic (nested object property, array second element, another property).
    3.1 : No parameter arrow funciton . return 89.
    3.2 : Single parameter arrow function. Will divide input by 7.
    3.3 : Arrow function with two parameters.
    3.4 : Multiline arrow funciton with two parameter.

    4. map divide each element by 7
    5. map, forEach, fileter, find
    6. destructuring on object and array. result in second variable.
    7. photo load from jsonplaceholder api. 
    8. when cliked the photo , then above shows the details of the photos like thumbnail or photos.
    9. practice forEach in jsonplaceholder api
    10. thecocktaildb api / meal db / sports db
    11. practice double equal (==) or tirple (===)
